...
define('NO_ITEM_FOUND_IN_DB', 'Aucun item trouvé dans la base de données!');
...
define('TAMPOON_ORDER', 'Commande item de');
define('THE', 'le');
...
define('SEND', 'Envoyer');
define('RESET_PASSWORD', 'Rétablir votre mot de passe pour '.$_SERVER['HTTP_HOST']);
define('CLICK_TO_RESET_PASSWD', 'Cliquez sur ce lien pour rétablir votre mot de passe pour '.$_SERVER['HTTP_HOST']);
