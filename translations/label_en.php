...
define('NO_ITEM_FOUND_IN_DB', 'No items in database!');
...
define('TAMPOON_ORDER', 'Item order from');
define('THE', 'the');
...
define('SEND', 'Send');
define('RESET_PASSWORD', 'Reset password for '.$_SERVER['HTTP_HOST']);
define('CLICK_TO_RESET_PASSWD', 'Click here to reset your password on '.$_SERVER['HTTP_HOST']);
...
define('LOGIN', 'Login');
define('FILL_25_WITH_1', 'Fill 25 with 1 quantity');
